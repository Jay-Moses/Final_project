...
engine = pyttsx3.init()
engine.say("Welcome to automated Attendance system!")
...
# Dialog box texts (unused in this snippet)
dialog_title = "QUIT"
...
try:
    ...
    bg_image = Image.open("UI_Image/002.png")  
    
    # Get actual screen dimensions for perfect fit
    ...
    # Ensure background stays at bottom layer
    bg_label.lower()
...
# Sample dialog destroy function
def del_sc1():
    if 'sc1' in globals():  # Check if sc1 exists
        sc1.destroy()
...
titl = tk.Label(
    window, text="SMART ATTENDANCE", bg="#1c1c1c", fg="yellow", font=("Verdana", 27, "bold"),
)
titl.place(x=525, y=12)

a = tk.Label(
    window,
    text="Welcome to SMART CLASS ATTENDANCE",
    bg="#1c1c1c",  # Dark background for the main text
    fg="white",  # Bright yellow text color
    bd=10,
